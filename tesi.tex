...
\begin{document}
	...
	It is a multiplatform C++ library for capturing, parsing, and crafting of network packets. As major features, there are that it is designed to be efficient, powerful, and easy to use. It is a wrapper for the most famous packet processing engines making easy forgin 
	...
	The protocol is perfect for implementing an attack to demonstrate how a node can maliciously and heavily modify the packet content.
